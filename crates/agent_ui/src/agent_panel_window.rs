use gpui::{
    AnyWindowHandle, App, Context, Entity, FocusHandle, Focusable as _, Render, Tiling,
    TitlebarOptions, WeakEntity, Window, WindowBounds, WindowOptions, point, prelude::*, px, size,
};
